(function(){
    'use strict';
    angular.module('app')
    .controller('reMortgageQuoteCtrl', ["$q", "$scope", "$log", "$timeout", "reMortgageQuotation", function ($q, $scope, $log, $timeout, reMortgageQuotation) {
        $scope.templateUrl = './views/pages/quotation/re-mortgage/remortgageAdd.html?v='+window.app_version
        $scope.subtitle = "New"
        ...
        $scope.nextPanel= function(valid){
            if(valid){
                ...
                $scope.templateUrl = './views/pages/quotation/re-mortgage/remortgageAdd1.html?v='+window.app_version
            }else{
        ...
        $scope.quoteData.transfer_of_equity = false;
        ...
        function saveQuote(valid, quoteForm){
            ...
            $scope.errorMsg = false;
            if(valid){
                reMortgageQuotation.create($scope.quoteData).then(function(response){
